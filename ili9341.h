...
#define __ILI9341_H__
  ...
  // Data
  // ---------------------------------------------------------------
  #define ILI9341_PORT_DATA     PORTA
  #define ILI9341_DDR_DATA      DDRA
  #define ILI9341_PIN_DATA      PINA
  // Control 
  // ---------------------------------------------------------------
  #define ILI9341_DDR_CONTROL   DDRD
  #define ILI9341_PORT_CONTROL  PORTD
